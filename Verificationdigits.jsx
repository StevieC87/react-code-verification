...
export default function VerificationDigits({ email }) {
  ...
  function handlePaste(e, idx, mode) {
    ...
    if (pasteddatalength > 1) {
      ...
      setDigit1(values[0] || '');
      inputRefs[idx].current.value = values[0] || '';

      setDigit2(values[1] || '');
      inputRefs[idx + 1].current.value = values[1] || '';

      setDigit3(values[2] || '');
      inputRefs[idx + 2].current.value = values[2] || '';

      setDigit4(values[3] || '');
      inputRefs[idx + 3].current.value = values[3] || '';

      setDigit5(values[4] || '');
      inputRefs[idx + 4].current.value = values[4] || '';

      setDigit6(values[5] || '');
      inputRefs[idx + 5].current.value = values[5] || '';
        ...
        {!switchscreensonsuccessshow && (
          <>
            ...
            <div className="flex flex-row justify-center items-center">
              <input className="verifinput" ref={inputRefs[0]} default="" type="text" min="1" max="9" id="firstdigit" name="firstdigit"
              ...
              />
              <input className="verifinput" ref={inputRefs[1]} type="text" min="1" max="9" id="firstdigit" name="seconddigit"
                //   onChange={(e) => onChangeinput(e, 1)}
                onKeyDown={(e) => Keyboardpress(e, 1)}
                //onKeyUp={(e) => handlePaste(e, 4, 'keyboardpaste')}
                onPaste={(e) => handlePaste(e, 1)}
              />
              <input className="verifinput" ref={inputRefs[2]} type="text" min="1" max="9" id="firstdigit" name="thirddigit"
                //  onChange={(e) => onChangeinput(e, 2)}
                onKeyDown={(e) => Keyboardpress(e, 2)}
                //onKeyUp={(e) => handlePaste(e, 4, 'keyboardpaste')}
                onPaste={(e) => handlePaste(e, 2)}
              />
              <input className="verifinput" ref={inputRefs[3]} type="text" min="1" max="9" id="firstdigit" name="fourthdigit"
                //  onChange={(e) => onChangeinput(e, 3)}
                onKeyDown={(e) => Keyboardpress(e, 3)}
                //onKeyUp={(e) => handlePaste(e, 4, 'keyboardpaste')}
                onPaste={(e) => handlePaste(e, 3)}
              />
              <input className="verifinput" ref={inputRefs[4]} type="text" min="1" max="9" id="firstdigit" name="fifthdigit"
                //  onChange={(e) => onChangeinput(e, 4)}
                onKeyDown={(e) => Keyboardpress(e, 4)}
                //onKeyUp={(e) => handlePaste(e, 4, 'keyboardpaste')}
                onPaste={(e) => handlePaste(e, 4)}
              />
              <input className="verifinput" ref={inputRefs[5]} type="text" min="1" max="9" id="firstdigit" name="sixthdigit"
